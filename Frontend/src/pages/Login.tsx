...
function Login({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      className={cn(
        "min-h-[calc(100vh-64px)] flex items-center justify-center bg-muted px-4 sm:px-14 pt-8",
        className
      )}
      {...props}
    >
        ...
        <Card className="overflow-hidden shadow-lg">
          <CardContent className="grid grid-cols-1 md:grid-cols-2 p-0">
            ...
            <div className="relative hidden md:block">
              <img
                src="https://plus.unsplash.com/premium_photo-1716603741447-7fcd7ddeba39"
                alt="Image"
